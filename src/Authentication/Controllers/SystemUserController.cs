...
public class SystemUserController : ControllerBase
{
    ...
    public async Task<ActionResult<List<Customer>>> GetClientsForFacilitator(int party, [FromQuery] Guid facilitator, [FromQuery] List<string> packages = null, CancellationToken cancellationToken = default)
    {
        var result = await _systemUserService.GetClientsForFacilitator(party, facilitator, packages, _featureManager, cancellationToken);
